...
export const heroLabels = {
  tr: {
    eyebrow: "Bağımsız Gelecek Oyun Teknolojileri",
    headline: "IFGT",
    line1: "Yarat.",
    line2: "Oyna.",
    line3: "İlham ver.",
    ...
    description:
      "İnsanlara bağlanan, hayranlık uyandıran ve ekran karardığında bile aklınızda kalan dünyalar kuruyoruz.",
    scroll: "Keşfetmek için kaydır",
  },
  en: {
    eyebrow: "Independent Future Game Technologies",
    headline: "IFGT",
    line1: "Create.",
    line2: "Play.",
    line3: "Inspire.",
    ...
    description:
      "We create worlds that connect people, spark wonder, and stay with you long after the screen fades to black.",
...
export const footerLabels = {
  tr: {
    explore: "Keşfet",
    connect: "Bağlan",
    tagline: "Bağımsız Gelecek Oyun Teknolojileri. Önemsenmeye değer deneyimler üretiyoruz.",
    sayHello: "Merhaba de",
  ...
  en: {
    explore: "Explore",
    connect: "Connect",
    tagline: "Independent Future Game Technologies. We make experiences worth caring about.",
    sayHello: "Say hello",
